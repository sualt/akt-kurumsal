    ...
    <div className="bg-[#f7f8fc] min-h-screen font-['Outfit',sans-serif]">
      ...
      <div className="max-w-5xl mx-auto px-6 pb-24 space-y-8 pt-8">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          ...
          <div>
            <h2 className="text-xl font-extrabold text-white mb-2">AKT Kurumsal Çalışma İzni Danışmanlığı</h2>
            <p className="text-white/70 text-sm leading-relaxed mb-2">
              AKT Kurumsal, Türkiye'de faaliyet gösteren işletmelere yabancı çalışma izni danışmanlığı alanında profesyonel hizmet sunan kurumsal bir danışmanlık firmasıdır.
            </p>
