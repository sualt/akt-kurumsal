      ...
      <div className="max-w-5xl mx-auto px-6 pb-24 space-y-8 pt-8">
        ...
        <div className="grid md:grid-cols-2 gap-5">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}
            ...
            <h3 className="text-sm font-bold text-white uppercase tracking-wider mb-2">Çözümx Kurumsal ile Dijital Dönüşüm</h3>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          ...
          <div className="flex-1">
            ...
            <p className="text-white/65 text-sm leading-relaxed">Çözümx Kurumsal ile markanızı dijital dünyada güçlü ve güvenilir şekilde temsil edin.</p>
          </div>
          <div className="flex flex-col sm:flex-row gap-3 flex-shrink-0">
            ...
            <a href="tel:+90553 077 74 48" className="inline-flex items-center justify-center gap-2 bg-white/10 text-white font-semibold px-7 py-4 rounded-xl border border-white/20 hover:bg-white/20 transition-all text-sm whitespace-nowrap">
