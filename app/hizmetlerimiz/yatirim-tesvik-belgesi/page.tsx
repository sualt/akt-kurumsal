  ...
  return (
    <div className="bg-[#f7f8fc] min-h-screen font-['Outfit',sans-serif]">
      ...
      <div className="max-w-5xl mx-auto px-6 pb-24 space-y-8 pt-8">
        ...
        {/* ── DESTEKLER + HİZMETLER + NEDEN ÇÖZÜMX ──────────────────────── */}
        <div className="grid md:grid-cols-3 gap-5">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}
            className="bg-white rounded-2xl border border-gray-100 shadow-sm p-7">
            <h3 className="text-sm font-bold text-[#0a2463] uppercase tracking-wider mb-5">ÇÖZÜMX Hizmetlerimiz</h3>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          ...
          <div className="flex flex-col sm:flex-row gap-3 flex-shrink-0">
            ...
            <a href="tel:+90553 077 74 88" className="inline-flex items-center justify-center gap-2 bg-white/10 text-white font-semibold px-7 py-4 rounded-xl border border-white/20 hover:bg-white/20 transition-all text-sm whitespace-nowrap">
